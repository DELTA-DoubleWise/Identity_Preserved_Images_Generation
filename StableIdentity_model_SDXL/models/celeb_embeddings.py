...
def embedding_forward(
        ...
        if embedding_manager is not None:
            inputs_embeds = embedding_manager(input_ids, inputs_embeds, 1, face_img_embeddings, timesteps)
...
def embedding_forward_2(
        ...
        if embedding_manager is not None:
            inputs_embeds = embedding_manager(input_ids, inputs_embeds, 2, face_img_embeddings, timesteps)
