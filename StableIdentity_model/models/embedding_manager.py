...
from StableIdentity_model.models.id_embedding.helpers import get_rep_pos, shift_tensor_dim0
from StableIdentity_model.models.id_embedding.meta_net import StyleVectorizer
from functools import partial
import torch.nn.functional as F
import torch.nn as nn
import torch.nn.init as init
from StableIdentity_model.models.celeb_embeddings import _get_celeb_embeddings_basis
...
class EmbeddingManagerId_adain(nn.Module):
    def __init__(
        ...
        ''' id embedding '''
        self.celeb_embeddings_mean, self.celeb_embeddings_std = _get_celeb_embeddings_basis(tokenizer, text_encoder, "StableIdentity_model/datasets_face/selected_celeb_names.txt")
